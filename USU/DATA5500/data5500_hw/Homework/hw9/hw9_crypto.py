...
# the API can only take so many requests at once so my inital try test1.py got an error and can't pull all exchange rates
# I tried addding a sleep timer but that still didn't fix the issues
# Chat GPT suggested sending all the requests over as a batch which I tried on test2.py and it mostly worked (yay!) but I wanted to change it to remove the loops from paths to themselves and use a permutation
# attempts on Class_Practice/Week_9_10/hw9_practice
